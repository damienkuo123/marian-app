(() => {
  ...
  const CATALOG_PATH = './unity/arenas/catalog-phase3r21-browser-final-20260811_022528.json';
  ...
  function handleRuntimeEvent(event) {
    ...
    updateDebug(`${kind || 'runtime'}${detail?.message ? ' · ' + String(detail.message).slice(0, 140) : ''}`);
    if (kind === 'ready') {
